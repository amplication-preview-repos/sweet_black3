...
class BowlUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => StatusUpdateUpdateManyWithoutBowlsInput,
  })
  @ValidateNested()
  @Type(() => StatusUpdateUpdateManyWithoutBowlsInput)
  @IsOptional()
  @Field(() => StatusUpdateUpdateManyWithoutBowlsInput, {
    nullable: true,
  })
  statusUpdates?: StatusUpdateUpdateManyWithoutBowlsInput;
}

export { BowlUpdateInput as BowlUpdateInput };
